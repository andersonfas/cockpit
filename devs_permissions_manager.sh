...
echo "╔══════════════════════════════════════════════════════════════════╗"
echo "║  DevOps Permissions - Ambiente de Desenvolvimento                 ║"
...
RESTRIÇÃO POR TIME:
    ...
    Exemplo:
        joao.silva no time BACKEND só acessa api-*
        pedro.oliveira no time FRONTEND só acessa frontend-*
...
show_version() {
    ...
    echo "DevOps Permissions Manager"
    echo "Ambiente: $ENVIRONMENT"
}
...
<head>
    ...
    <title>DevOps Permissions Dashboard</title>
    <style>
...
<body>
    ...
    <footer class="footer">DevOps Permissions Manager v$SCRIPT_VERSION | Gerado: $(_ts)</footer>
